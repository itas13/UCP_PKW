                ...
                <div class="modal-content">
                   <form method="post" action="store.php" name="form">
                        <div class="modal-header">
                            <h5 class="modal-title" id="tambahDataLabel">List Karyawan</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="No_KTP" placeholder="Masukkan No_KTP " name="No_KTP" required>
                                </div>
                                <div class="mb-3">
                                    <label for="No_Telp" class="form-label">No_Telp</label>
                                    <input type="text" class="form-control" id="No_Telp" placeholder="Masukkan No_Telp" name="No_Telp" required>
                                </div>
                                <div class="mb-3">
                                    <label for="Tahun_Masuk" class="form-label">Tahun_Masuk</label>
                                    <input type="text" class="form-control" id="Tahun_Masuk" placeholder="Masukkan Tahun_Masuk" name="Tahun_Masuk" required>
                                </div>
